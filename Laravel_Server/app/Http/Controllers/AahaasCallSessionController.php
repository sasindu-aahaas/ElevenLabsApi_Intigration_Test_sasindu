...
class AahaasCallSessionController extends Controller
{
    public function __invoke(ElevenLabsReceptionCallService $service): JsonResponse
    {
        try {
            ...
            return response()->json([
                'message' => $throwable->getMessage() !== '' ? $throwable->getMessage() : 'Aahaas call session could not be started.',

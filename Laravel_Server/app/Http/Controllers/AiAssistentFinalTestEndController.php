...
class AiAssistentFinalTestEndController extends Controller
{
    public function __invoke(Request $request, AiAssistentFinalTestService $service): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'message' => $throwable->getMessage() !== '' ? $throwable->getMessage() : 'AI ASSISTENT FINAL TEST call could not be completed.',

...
class AiAssistentFinalTestTurnController extends Controller
{
    public function __invoke(Request $request, AiAssistentFinalTestService $service): JsonResponse
    {
        ...
        try {
            ...
            if (($mergedProfile['package_state'] ?? '') === 'offered' && $packageFeedback === 'accepted') {
                ...
                // Keep ChatGPT-generated reply for natural variation
            ...
            return response()->json([
                'message' => $throwable->getMessage() !== '' ? $throwable->getMessage() : 'AI ASSISTENT FINAL TEST call turn failed.',

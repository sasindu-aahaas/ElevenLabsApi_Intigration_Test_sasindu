...
class ReceptionCallSessionController extends Controller
{
    public function __invoke(ReceptionCallService $service): JsonResponse
    {
        try {
            ...
            $holdAudio = $service->synthesizeSpeech(
                $holdMessage,
                'Speak calmly and elegantly like a premium receptionist during hold music.'
            );
            ...
            return response()->json([
                'message' => $throwable->getMessage() !== '' ? $throwable->getMessage() : 'Reception call session could not be started.',

...
class UvinduCallSessionController extends Controller
{
    public function __invoke(UvinduCallService $service): JsonResponse
    {
        try {
            ...
            return response()->json([
                'message' => $throwable->getMessage() !== '' ? $throwable->getMessage() : 'Uvindu call session could not be started.',
